        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Avaliaco>(entity =>
            {
                entity.HasKey(e => e.IdAvaliacao)
                    .HasName("PK__Avaliaco__2A0C8312D5B4CBB5");
            ...
            modelBuilder.Entity<Cartao>(entity =>
            {
                entity.HasKey(e => e.IdCartao)
                    .HasName("PK__Cartao__C212DE2582DDDD29");

                entity.ToTable("Cartao");

                entity.HasIndex(e => e.Numero, "UQ__Cartao__7E532BC6B7277C3E")
                    .IsUnique();
            ...
            modelBuilder.Entity<Condico>(entity =>
            {
                entity.HasKey(e => e.IdCondicao)
                    .HasName("PK__Condicoe__EC5ECA4C6DCAEFBD");

                entity.HasIndex(e => e.Condicao, "UQ__Condicoe__C18D4BADA4CBC226")
                    .IsUnique();
            ...
            modelBuilder.Entity<Emprestimo>(entity =>
            {
                entity.HasKey(e => e.IdEmprestimo)
                    .HasName("PK__Empresti__4B4C8860B53721E1");
            ...
            modelBuilder.Entity<EmprestimosOption>(entity =>
            {
                entity.HasKey(e => e.IdEmprestimoOption)
                    .HasName("PK__Empresti__1400F9A137CDBDE5");
            ...
            modelBuilder.Entity<ImgsPost>(entity =>
            {
                entity.HasKey(e => e.IdImg)
                    .HasName("PK__ImgsPost__3C3EAB5A0F62B8B8");
            ...
            modelBuilder.Entity<Inventario>(entity =>
            {
                entity.HasKey(e => e.IdInventario)
                    .HasName("PK__Inventar__8F145B0D053FF6BF");
            ...
            modelBuilder.Entity<Investimento>(entity =>
            {
                entity.HasKey(e => e.IdInvestimento)
                    .HasName("PK__Investim__93C8510B425DCBD0");
            ...
            modelBuilder.Entity<InvestimentoOption>(entity =>
            {
                entity.HasKey(e => e.IdInvestimentoOption)
                    .HasName("PK__Investim__DA79A85EA8667BBC");

                entity.HasIndex(e => e.Nome, "UQ__Investim__7D8FE3B23FC9DE06")
                    .IsUnique();

                entity.HasIndex(e => e.CodeId, "UQ__Investim__C6DE2C143CDCD61D")
                    .IsUnique();
            ...
            modelBuilder.Entity<Marketplace>(entity =>
            {
                entity.HasKey(e => e.IdPost)
                    .HasName("PK__Marketpl__BE0F4FD6F1EF2223");
            ...
            modelBuilder.Entity<Meta>(entity =>
            {
                entity.HasKey(e => e.IdMeta)
                    .HasName("PK__Metas__C26D05DE0AB2965F");
            ...
            modelBuilder.Entity<TipoInvestimento>(entity =>
            {
                entity.HasKey(e => e.IdTipoInvestimento)
                    .HasName("PK__TipoInve__7024AB4CDAB23F12");

                entity.HasIndex(e => e.TipoInvestimento1, "UQ__TipoInve__C197F226A7D55A22")
                    .IsUnique();
            ...
            modelBuilder.Entity<Transaco>(entity =>
            {
                entity.HasKey(e => e.IdTransacao)
                    .HasName("PK__Transaco__455E3CA0BF9E27EE");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuarios__645723A64C8E7356");

                entity.HasIndex(e => e.Telefone, "UQ__Usuarios__4EC504B65DC09EA3")
                    .IsUnique();

                entity.HasIndex(e => e.Email, "UQ__Usuarios__A9D10534D9521107")
                    .IsUnique();

                entity.HasIndex(e => e.Cpf, "UQ__Usuarios__C1F89731B94AB298")
                    .IsUnique();
