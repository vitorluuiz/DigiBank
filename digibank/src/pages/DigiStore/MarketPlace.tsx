  ...
  return (
    <div>
      ...
      <main id="digistore" className="container">
        ...
        {/* <section className="suport-list">
            <div className="box-top-support">
              <h2>Comprar Novamente</h2>
              <Link to="/digistore/comprados">
                Ver Mais <img src={Seta} alt="seta ver mais" />
              </Link>
            </div>
            <CarouselPosts type="comprados" />
          </section>
        )}
        {showSections[1] && (
          <section className="suport-list">
            <div className="box-top-support">
              <h2>Abaixo de R$50</h2>
              <Link to="/digistore/50">
                Ver Mais <img src={Seta} alt="seta ver mais" />
              </Link>
            </div>
            <CarouselPosts type="valor" maxValue={50} />
          </section>
        )}
        {showSections[2] && (
          <section className="suport-list">
            <div className="box-top-support">
              ...
              <Link to="/digistore/25">
                Ver Mais <img src={Seta} alt="seta ver mais" />
              </Link>
            </div>
            <CarouselPosts type="valor" maxValue={25} />
          </section>
        )}
        {showSections[3] && (
          <section className="suport-list">
            ...
            <CarouselPosts type="valor" maxValue={5} />
          </section>
        )}
        {showSections[4] && (
          <section className="suport-list">
            ...
            <CarouselPosts type="valor" maxValue={0} />
          </section> */}
      </main>
      <Footer />
    </div>
